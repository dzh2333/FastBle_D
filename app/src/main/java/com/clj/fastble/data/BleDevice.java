...
public class BleDevice implements Parcelable {
    ...
    private ScanRecord dScanRecord;
    private int mRssi;
    ...
    public BleDevice(BluetoothDevice mDevice, byte[] mScanRecord, ScanRecord dScanRecord, int mRssi, long mTimestampNanos) {
    ...
    public ScanRecord getdScanRecord() {
        return dScanRecord;
    }

    public void setdScanRecord(ScanRecord dScanRecord) {
        this.dScanRecord = dScanRecord;
    }
}
